...
#define HORIZONTAL_TOOLBAR_STYLESHEET "QToolBar {\
    border: 1px solid #6f9488;\
    background: 1px solid #6f7c94;\
    font-weight: bold;\
}"
...
{
    resize(1070, 660);
    setWindowTitle(tr("cloudtokens") + " - " + tr("Wallet"));
#ifndef Q_OS_MAC
    qApp->setWindowIcon(QIcon(":icons/cloudtokens"));
    setWindowIcon(QIcon(":icons/cloudtokens"));
#else
	...
	sharecloudPage = new ShareCloudPage(this);
	...
	centralWidget->addWidget(sharecloudPage);
...
void BitcoinGUI::createActions()
{
    ...
    blockAction->setToolTip(tr("Explore the cloudtokens Blockchain"));
    blockAction->setShortcut(QKeySequence(Qt::ALT + Qt::Key_6));
    blockAction->setCheckable(true);
    tabGroup->addAction(blockAction);

	sharecloudAction = new QAction(QIcon(":/icons/sharecloud"), tr("&ShareCloud"), this);
    sharecloudAction->setStatusTip(tr("go to ShareCloud Page"));
    sharecloudAction->setToolTip(sharecloudAction->statusTip());
    sharecloudAction->setCheckable(true);
    tabGroup->addAction(sharecloudAction);
	
    sendCoinsAction = new QAction(QIcon(":/icons/send"), tr("&Send coins"), this);
    sendCoinsAction->setToolTip(tr("Send coins to a cloudtokens address"));
	...
	connect(sharecloudAction, SIGNAL(triggered()), this, SLOT(gotoShareCloudPage()));
    ...
    aboutAction = new QAction(QIcon(":/icons/bitcoin"), tr("&About cloudtokens"), this);
    aboutAction->setToolTip(tr("Show information about cloudtokens"));
    aboutAction->setMenuRole(QAction::AboutRole);
    aboutQtAction = new QAction(QIcon(":/trolltech/qmessagebox/images/qtlogo-64.png"), tr("About &Qt"), this);
    aboutQtAction->setToolTip(tr("Show information about Qt"));
    aboutQtAction->setMenuRole(QAction::AboutQtRole);
    optionsAction = new QAction(QIcon(":/icons/options"), tr("&Options..."), this);
    optionsAction->setToolTip(tr("Modify configuration options for cloudtokens"));
...
void BitcoinGUI::createToolBars()
{
	...
	mainToolbar->addAction(sharecloudAction);
...
void BitcoinGUI::setClientModel(ClientModel *clientModel)
{
    ...
    if(clientModel)
    {
        ...
        if(clientModel->isTestNet())
        {
            ...
            if(trayIcon)
            {
                trayIcon->setToolTip(tr("cloudtokens client") + QString(" ") + tr("[testnet]"));
...
void BitcoinGUI::createTrayIcon()
{
    ...
    trayIcon->setToolTip(tr("cloudtokens client"));
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to cloudtokens network", "", count));
}
...
void BitcoinGUI::gotoShareCloudPage()
{
    sharecloudAction->setChecked(true);
    centralWidget->setCurrentWidget(sharecloudPage);
...
void BitcoinGUI::dropEvent(QDropEvent *event)
{
    if(event->mimeData()->hasUrls())
    {
        ...
        if (nValidUrisFound)
            ...
            notificator->notify(Notificator::Warning, tr("URI handling"), tr("URI can not be parsed! This can be caused by an invalid cloudtokens address or malformed URI parameters."));
    }
