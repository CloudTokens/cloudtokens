// Copyright (c) 2014 The cloudtokens developers
...
void ThreadSecureMsg(void* parg)
{
    ...
    RenameThread("cloudtokens-smsg"); // Make this thread recognisable
...
void ThreadSecureMsgPow(void* parg)
{
    ...
    RenameThread("cloudtokens-smsg-pow"); // Make this thread recognisable
